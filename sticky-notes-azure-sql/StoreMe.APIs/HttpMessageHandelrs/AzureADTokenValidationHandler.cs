namespace StoreMe.APIs.HttpMessageHandlers
{
    ...
    public class AzureADTokenValidationHandler : DelegatingHandler
    {
        ...
        protected async override Task<HttpResponseMessage> SendAsync(HttpRequestMessage request, CancellationToken cancellationToken)
        {
            try
            {
                ...
                return await ValidateAzureADToken(request, cancellationToken, jwtToken, authority, audience);
            }
        ...
        private async Task<HttpResponseMessage> ValidateAzureADToken(HttpRequestMessage request, CancellationToken cancellationToken, string token, string authority, string audience)
        {
            string issuer;
